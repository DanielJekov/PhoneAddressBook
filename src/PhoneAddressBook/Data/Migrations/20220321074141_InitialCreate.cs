...
namespace PhoneAddressBook.Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountriesDataHash", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(26)", maxLength: 26, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Records_FirstName",
                table: "Records",
                column: "FirstName");

            migrationBuilder.CreateIndex(
                name: "IX_Records_LastName",
                table: "Records",
                column: "LastName");

            migrationBuilder.CreateIndex(
                name: "IX_Records_PhoneNumber",
                table: "Records",
                column: "PhoneNumber");
